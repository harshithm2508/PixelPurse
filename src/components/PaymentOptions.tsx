...
export default function PaymentOption({nameOfCard, cardNumber} : PaymentOptionProps){
    return(
        <div className=" hover:cursor-pointer hover:border-b-2 hover:border-l-2 hover:border-r-2 rounded-lg hover:pb-1 pr-20 pt-2 pl-4 hover:shadow-xl hover:shadow-blue-200  mt-1 mb-2 flex justify-between items-center">
