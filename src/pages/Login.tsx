...
export default function Login(){
    return(
        <div className="w-full h-screen-minus-20 flex justify-center">
            <div className="sm:w-1/2 min-w-0.5 h-1/2 mt-14 md:mt-5 lg:mt-5 xl:mt-14">
                ...
                <div className="mt-4 w-full sm:w-9/12 md:w-8/12 text-center font-semibold text-gray-500 mb-4">Don't have an account ? <Link className=" text-blue-800" to={'/signup'}>Sign Up</Link></div>
