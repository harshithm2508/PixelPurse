    ...
    return(
        <div className="w-full h-screen-minus-20 flex justify-center">
            <div className="sm:w-1/2 min-w-0.5 h-1/2 mt-14 sm:mt-0">
                ...
                <Button text="Login" margin="mt-6" bgColor="bg-blue-700" color="text-white" width="w-full sm:w-9/12 md:w-8/12"/>
                <div className="text-center">OR</div>
                <Button text="Connect with Google" bgColor="bg-gray-200" color="text-gray-900" width="w-full sm:w-9/12 md:w-8/12"/>
                <div className="mt-4 font-semibold text-center text-gray-500 mb-4">Already have an account ? <Link className=" text-blue-800" to={'/login'}>Sign Up</Link></div>
