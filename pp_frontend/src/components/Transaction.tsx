    ...
    return(
        <div className=" flex border-b-2 justify-between items-center p-2">
            <div className=" flex gap-5">
                <div className=" bg-blue-300 rounded-full font-comfortaa h-10 w-10 flex justify-center items-center">{naam[0][0]+naam[1][0]}</div>
                <div>
            ...
            {process == 'sent' ? <div className=" text-red-600 text-center font-semibold"> <span>&#8377;</span> {amount}</div> : <div className=" text-green-500 text-center font-semibold"> <span>&#8377;</span> {amount}</div>}
        </div>
    )
}
